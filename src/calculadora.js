...
function Calculadora() {
  ...
  function definirOperacao(op){
    ...
    if (numero2 !== null){
      const resultOP = calcular(parseFloat(numero1),parseFloat(numero2),operacao);

      setOperacao(op);
      setNumero1(resultOP.toString());
      setNumero2(null);
      setTxtNumeros(resultOP.toString());
    }
  }
  ...
  return (
    <Jumbotron style={{
      ...
      <Container>
        <Row>
          <Col xs="3">
            <Button variant="danger" onClick={limparDados}>C</Button>
          </Col>
          <Col xs="9">
